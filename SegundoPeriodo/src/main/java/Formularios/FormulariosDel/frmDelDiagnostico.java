 ...
 * @author Leoni
 */
public class frmDelDiagnostico extends javax.swing.JFrame {
    Conexion cn=new Conexion();
    Connection cone;
    Statement st;
    ResultSet rs;
    /**
     * Creates new form frmDelDiagnostico
     */
    public frmDelDiagnostico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Eliminar Diagnostico");
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        try{
            ...
            pst=con2.prepareStatement("SELECT dg.idDiagnostico, md.nombre, pc.dui, pc.nombrePaciente, ct.tipoConsulta, dg.descripcion, mc.Descripcion \n" +
                                                            ...
                                                            "WHERE dg.idDiagnostico like'"+(b)+"%'  LIMIT 1");
            rs = pst.executeQuery();
            while(rs.next())
            {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       java.sql.Connection con2 = null;
        ...
        try{
            con2 = cn.getConnection();
            pst=con2.prepareStatement("DELETE FROM diagnostico WHERE `diagnostico`.`idDiagnostico` = "
                    + "(SELECT idDiagnostico FROM `diagnostico` WHERE idDiagnostico like'"+(m)+"%' LIMIT 1)");
            ...
            t.setRowCount(0);
            tblDiag.setModel(t);
            JOptionPane.showMessageDialog(this, "Diagnostico Eliminado con Exito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDelDiagnostico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmDelDiagnostico().setVisible(true);
            }
        });
    }
